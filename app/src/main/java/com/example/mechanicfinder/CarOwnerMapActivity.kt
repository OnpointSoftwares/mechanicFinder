...
import com.example.mechanicfinder.databinding.ActivityCarOwnerMapBinding
import com.google.android.gms.maps.model.*
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*

class CarOwnerMapActivity : AppCompatActivity(), OnMapReadyCallback,LocationListener{

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityCarOwnerMapBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCarOwnerMapBinding.inflate(layoutInflater)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        refference.child("availableMechanics").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (user == null) {
                    Log.e(TAG, "User data is null")
                    Toast.makeText(this@CarOwnerMapActivity,"No available mechanics at the moment",Toast.LENGTH_LONG).show()
                    return
                }
                ...
                fusedLocationClient.lastLocation
                    .addOnSuccessListener { location ->
                        ...
                        refference.child("carOwner").child(FirebaseAuth.getInstance().currentUser!!.uid).setValue(latlong).addOnCompleteListener {
                                Toast.makeText(this@CarOwnerMapActivity,"location updated successfully",Toast.LENGTH_LONG).show()
                        }.addOnFailureListener {
                            Toast.makeText(this@CarOwnerMapActivity,"Location update error",Toast.LENGTH_LONG).show()
                        }
